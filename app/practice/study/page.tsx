...
export default function Page() {
    ...
    return (
        <div className="flex flex-col w-full h-full gap-4">
            ...
            <div className="flex-1 overflow-y-auto flex flex-col max-w-2xl w-full mx-auto rounded-lg border-2 border-gray-200 p-4">
                <ChatDisplay chatHistory={chatHistory} />
            </div>
            <div className="flex-none">
                <div className="max-w-lg mx-auto border-t border-gray-200 mx-4" />
            </div>
            <div className="flex-none max-w-2xl w-full mx-auto rounded-lg border-2 border-gray-200 p-4">
