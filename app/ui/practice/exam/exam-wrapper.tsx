                ...
                <>
                    ...
                    {currentQuestion.isRevealed && !isChatOpen && (
                        <button
                            ...
                            className="fixed z-20 flex bottom-2 right-2 size-10 md:bottom-6 md:right-6 md:size-20 items-center justify-center rounded-full bg-assistant text-button-text shadow-lg transition-colors hover:bg-assistant/80 cursor-pointer">
